...
export const AGENT_CONFIG = {
  financial_advisor: {
    ...
    isActive: true,
    priority: 5,
    specializations: ['comprehensive_guidance', 'goal_setting', 'agent_coordination', 'holistic_planning'],
    contextWindow: 20,
  ...
  budget_coach: {
    ...
    isActive: true,
    priority: 5,
    specializations: ['envelope_budgeting', 'budget_creation', 'fund_allocation', 'category_optimization'],
    contextWindow: 20,
  ...
  transaction_analyst: {
    ...
    isActive: true,
    priority: 5,
    specializations: ['spending_analysis', 'transaction_categorization', 'pattern_recognition', 'anomaly_detection'],
    contextWindow: 20,
    riskLevel: 'low' as const,
    requiresAuth: true,
  ...
  crisis_agent: {
    ...
    isActive: true,
    priority: 5,
    specializations: ['crisis_intervention', 'emergency_planning', 'stress_management', 'immediate_action'],
    contextWindow: 20,
  ...
  onboarding_agent: {
    ...
    isActive: true,
    priority: 5,
    specializations: ['user_onboarding', 'financial_education', 'initial_setup', 'system_introduction'],
    contextWindow: 20,
    riskLevel: 'low' as const,
    requiresAuth: true,
